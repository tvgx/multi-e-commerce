        ...
        <section className="w-full py-24 bg-slate-50 overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 md:px-12 flex flex-col md:flex-row items-end justify-between mb-12 gap-6">
                <div className="max-w-xl">
                    <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-4">Featured Collection</h2>
                    <p className="text-slate-600 text-lg">Our most loved pieces, designed with precision and crafted for ultimate comfort.</p>
                </div>
