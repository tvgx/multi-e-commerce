                ...
                {items.map((i) => (
                    <a href="#" key={i} className="min-w-[280px] md:min-w-[350px] snap-center group block">
                        <div className="w-full h-[400px] rounded-2xl overflow-hidden mb-4 relative bg-slate-100">
                            <SmartImage src={defaultAsset('default-2.png')} alt="Collection" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" sizes="(min-width: 768px) 33vw, 80vw" />
                        </div>
