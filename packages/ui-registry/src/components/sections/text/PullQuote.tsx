    ...
    return (
        <section className="w-full py-24 md:py-32 bg-slate-50 flex justify-center items-center px-4">
            <blockquote className="max-w-4xl text-center relative">
                <span className="absolute -top-16 -left-8 text-[120px] text-white/50 font-serif leading-none select-none z-0">&quot;</span>
                ...
                <footer className="text-sm font-bold uppercase tracking-widest text-brand">
                    — The Style Quarterly
                </footer>
            </blockquote>
        </section>
