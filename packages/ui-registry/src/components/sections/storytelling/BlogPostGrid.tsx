        ...
        <section className="w-full py-20 px-4 md:px-12" style={{ backgroundColor: backgroundColor || '#ffffff' }}>
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    ...
                    <a href="#" className="font-bold uppercase tracking-widest text-brand text-sm hover:text-brand mt-4 inline-block">View All Posts &rarr;</a>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {[1, 2, 3, 4, 5, 6].map((i) => (
                        <a href="#" key={i} className="group flex flex-col">
                            ...
                            <h3 className="text-xl font-bold text-slate-900 group-hover:text-brand transition-colors leading-tight mb-3">Understanding the shift towards sustainable materials in 2024</h3>
