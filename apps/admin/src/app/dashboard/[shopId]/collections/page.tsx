                  ...
                  <tr key={collection.id} className="hover:bg-white/[0.02] transition-colors group">
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <Link href={`/dashboard/${shopId}/collections/${collection.id}`} className="font-medium text-white hover:underline group-hover:text-indigo-400 transition-colors">
                            {collection.title}
                          </Link>
                    ...
                    <td className="px-6 py-4 text-right">
                      <Link href={`/dashboard/${shopId}/collections/${collection.id}`} className="p-2 rounded-lg hover:bg-white/10 text-slate-400 transition-colors inline-flex">
