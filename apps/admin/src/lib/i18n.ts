/**
 * Server-side i18n helpers for the admin dashboard.
 *
 * Reads the seller's chosen language from the `NEXT_LOCALE` cookie and returns a
 ...
 *
 * Server components:  const t = await getT('shop'); t('dashboard.title')
